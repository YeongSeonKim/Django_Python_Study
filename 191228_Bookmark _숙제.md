...
![image-20200102010643451](images/image-20200102010643451.png)

Django 패키지 버전(2.X) 선택해서 설치한다.

![image-20200102010727637](images/image-20200102010727637.png)

설치가완료되면 초록색의 성공했다는 영어문구가 뜬다. X 창을 누른뒤 settings 창에서 설치가 된것을 확인 할 수 있다.

![image-20200102011156666](images/image-20200102011156666.png)